...
class Login extends Component {
    ...
    render() {
        return <>
            ...
            <p className='login'>Be sure to read our <Link to='/about/privacy-policy'>Privacy Policy</Link> and <Link to='/about/terms-of-service'>Terms of Service</Link> before logging in.</p>
            <fieldset>
